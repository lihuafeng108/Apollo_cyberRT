...
// source: proto/choreography_conf.proto
...
extern PROTOBUF_INTERNAL_EXPORT_proto_2fchoreography_5fconf_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto;
namespace apollo {
namespace cyber {
namespace proto {
...
static void InitDefaultsscc_info_ChoreographyConf_proto_2fchoreography_5fconf_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_ChoreographyConf_proto_2fchoreography_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_ChoreographyConf_proto_2fchoreography_5fconf_2eproto}, {
      &scc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto.base,}};

static void InitDefaultsscc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fchoreography_5fconf_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_proto_2fchoreography_5fconf_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_proto_2fchoreography_5fconf_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_proto_2fchoreography_5fconf_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_proto_2fchoreography_5fconf_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\035proto/choreography_conf.proto\022\022apollo."
  "cyber.proto\"D\n\020ChoreographyTask\022\014\n\004name\030"
  "\001 \001(\t\022\021\n\tprocessor\030\002 \001(\005\022\017\n\004prio\030\003 \001(\r:\001"
  "1\"\367\002\n\020ChoreographyConf\022\"\n\032choreography_p"
  "rocessor_num\030\001 \001(\r\022\035\n\025choreography_affin"
  "ity\030\002 \001(\t\022%\n\035choreography_processor_poli"
  "cy\030\003 \001(\t\022#\n\033choreography_processor_prio\030"
  "\004 \001(\005\022\033\n\023choreography_cpuset\030\005 \001(\t\022\032\n\022po"
  "ol_processor_num\030\006 \001(\r\022\025\n\rpool_affinity\030"
  "\007 \001(\t\022\035\n\025pool_processor_policy\030\010 \001(\t\022\033\n\023"
  "pool_processor_prio\030\t \001(\005\022\023\n\013pool_cpuset"
  "\030\n \001(\t\0223\n\005tasks\030\013 \003(\0132$.apollo.cyber.pro"
  "to.ChoreographyTask"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_proto_2fchoreography_5fconf_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fchoreography_5fconf_2eproto_sccs[2] = {
  &scc_info_ChoreographyConf_proto_2fchoreography_5fconf_2eproto.base,
  &scc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_proto_2fchoreography_5fconf_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fchoreography_5fconf_2eproto = {
  false, false, descriptor_table_protodef_proto_2fchoreography_5fconf_2eproto, "proto/choreography_conf.proto", 499,
  &descriptor_table_proto_2fchoreography_5fconf_2eproto_once, descriptor_table_proto_2fchoreography_5fconf_2eproto_sccs, descriptor_table_proto_2fchoreography_5fconf_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_proto_2fchoreography_5fconf_2eproto::offsets,
  file_level_metadata_proto_2fchoreography_5fconf_2eproto, 2, file_level_enum_descriptors_proto_2fchoreography_5fconf_2eproto, file_level_service_descriptors_proto_2fchoreography_5fconf_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_proto_2fchoreography_5fconf_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fchoreography_5fconf_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
...
void ChoreographyTask::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ChoreographyTask_proto_2fchoreography_5fconf_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  processor_ = 0;
  prio_ = 1u;
}
...
void ChoreographyConf::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ChoreographyConf_proto_2fchoreography_5fconf_2eproto.base);
  choreography_affinity_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  choreography_processor_policy_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  choreography_cpuset_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  pool_affinity_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
