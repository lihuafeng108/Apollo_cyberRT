...
static void InitDefaultsscc_info_Clock_proto_2fclock_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Clock_proto_2fclock_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Clock_proto_2fclock_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto_2fclock_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_proto_2fclock_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_proto_2fclock_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_proto_2fclock_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_proto_2fclock_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021proto/clock.proto\022\022apollo.cyber.proto\""
  "\026\n\005Clock\022\r\n\005clock\030\001 \002(\004"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_proto_2fclock_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto_2fclock_2eproto_sccs[1] = {
  &scc_info_Clock_proto_2fclock_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_proto_2fclock_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fclock_2eproto = {
  false, false, descriptor_table_protodef_proto_2fclock_2eproto, "proto/clock.proto", 63,
  &descriptor_table_proto_2fclock_2eproto_once, descriptor_table_proto_2fclock_2eproto_sccs, descriptor_table_proto_2fclock_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_proto_2fclock_2eproto::offsets,
  file_level_metadata_proto_2fclock_2eproto, 1, file_level_enum_descriptors_proto_2fclock_2eproto, file_level_service_descriptors_proto_2fclock_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_proto_2fclock_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_proto_2fclock_2eproto)), true);
namespace apollo {
namespace cyber {
namespace proto {
...
const Clock& Clock::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Clock_proto_2fclock_2eproto.base);
